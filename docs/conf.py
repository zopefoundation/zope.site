#!/usr/bin/env python3
#
# zope.site documentation build configuration file, created by
...
rqmt = pkg_resources.require('zope.site')[0]
...
latex_documents = [
    ('index', 'zopesite.tex', 'zope.site Documentation',
...
man_pages = [
    ('index', 'zopesite', 'zope.site Documentation',
...
texinfo_documents = [
    ('index', 'zopesite', 'zope.site Documentation',
     'Zope Foundation and Contributors', 'zopesite',
...
intersphinx_mapping = {
    ...
    'zopeinterface': (
        ...
        None),
    'zopecontainer': (
        'https://zopecontainer.readthedocs.io/en/latest/',
        None),
    'zopetraversing': (
        'https://zopetraversing.readthedocs.io/en/latest/',
        None),
    'zopepublisher': (
        'https://zopepublisher.readthedocs.io/en/latest/',
        None),
}

extlinks = {'issue': ('https://github.com/zopefoundation/zope.site/issues/%s',
                      'issue #'),
            'pr': ('https://github.com/zopefoundation/zope.site/pull/%s',
                   'pull request #')}
